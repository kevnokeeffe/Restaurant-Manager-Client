...
describe("Testing the logged in home page", () => {
  ...
  it("should show the nav-bar header", () => {
    cy.get(".navbar").within(() => {
      cy.get(".navbar-brand")
        .should("contain", "Restaurant Manager")
        .eq(0);
      cy.get(".navbar-toggler").eq(0);
    });
  });
    ...
    cy.get(".jumbotron")
      ...
      .within(() => {
        cy.get(".container")
          ...
          .within(() => {
            cy.get(".display-4")
              .should("contain", "Restaurant Manager Client")
              .eq(0);
            cy.get(".lead")
              .should(
                "contain",
                "This is a a restaurant manager application, built with MongoDB, ExpressJS, VueJS and NodeJS technologies."
              )
              .eq(0);
            cy.get(".dot").eq(0);
            cy.get(".line")
              ...
              .eq(0);
            cy.get(".btn")
              .should("contain", "View All Orders")
              .eq(0);
            cy.get(".btn")
              .should("contain", "View Kevin's Orders")
              .eq(1);
            cy.get(".btn")
