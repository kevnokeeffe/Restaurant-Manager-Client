<template>
  <div class="jumbotron jumbotron-fluid custom-bg-dark">
    <div class="container">
      ...
      <p class="lead align-content-center ml-4 mr-4">This is a a restaurant manager application, built with MongoDB, ExpressJS, VueJS and NodeJS technologies.</p>
      <hr class="dot my-4">
      ...
      <router-link v-if="$store.state.isLoggedIn" class="btn btn-success btn-lg display:inline ml-4 mt-2" to="/order/user">View {{this.$store.state.fName}}'s Orders</router-link>
